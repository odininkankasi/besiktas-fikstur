    ...
    <section className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 sm:gap-3">
        ...
        <div
          ...
          className="group cursor-pointer p-3.5 sm:p-4 rounded-2xl bg-neutral-900/60 hover:bg-neutral-900/90 border border-neutral-800 hover:border-red-900/60 transition-all flex items-center justify-between shadow-lg shadow-black/40"
        >
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-red-600/10 border border-red-500/30 flex items-center justify-center text-red-500 shrink-0 group-hover:scale-105 transition-transform">
              <Trophy className="w-4 h-4 sm:w-5 sm:h-5" />
            </div>
            <div className="min-w-0">
              <div className="text-[10px] sm:text-[11px] font-bold text-neutral-400 uppercase tracking-wider flex items-center gap-1.5 truncate">
                <span className="truncate">Trendyol Süper Lig</span>
                <span className="w-1.5 h-1.5 rounded-full bg-red-500 shrink-0"></span>
              </div>
              <div className="text-xs sm:text-sm font-extrabold text-white mt-0.5 flex items-center gap-1.5 truncate">
                <span>Beşiktaş:</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-right shrink-0">
            <div>
              <div className="text-base sm:text-lg font-black text-white font-mono leading-none">
                {bjkSuperLig ? bjkSuperLig.points : 3} <span className="text-[10px] sm:text-xs text-neutral-400 font-normal">Puan</span>
              </div>
              <div className="text-[9px] sm:text-[10px] text-neutral-500 font-mono mt-0.5">
        ...
        <div
          ...
          className="group cursor-pointer p-3.5 sm:p-4 rounded-2xl bg-neutral-900/60 hover:bg-neutral-900/90 border border-neutral-800 hover:border-amber-900/60 transition-all flex items-center justify-between shadow-lg shadow-black/40"
        >
          <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <div className="text-[10px] sm:text-[11px] font-bold text-neutral-400 uppercase tracking-wider flex items-center gap-1.5 truncate">
                <span className="truncate">UEFA Avrupa Ligi</span>
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-right shrink-0">
            <div>
              <div className="text-base sm:text-lg font-black text-white font-mono leading-none">
                {europaPoints} <span className="text-[10px] sm:text-xs text-neutral-400 font-normal">Puan</span>
              </div>
              <div className="text-[9px] sm:text-[10px] text-neutral-500 font-mono mt-0.5">

  ...
  return (
    <section className="w-full space-y-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-2 sm:gap-2.5">
        {/* Toplam Oynanan */}
        <div className="p-3 sm:p-3.5 rounded-2xl bg-neutral-900/60 border border-neutral-800/80 flex flex-col items-center justify-center text-center shadow-md">
          <span className="text-[10px] sm:text-[11px] font-extrabold text-neutral-400 uppercase tracking-wider block">
            OYNANAN
          </span>
        ...
        {/* Galibiyet */}
        <div className="p-3 sm:p-3.5 rounded-2xl bg-neutral-900/60 border border-emerald-950/40 flex flex-col items-center justify-center text-center shadow-md">
          <span className="text-[10px] sm:text-[11px] font-extrabold text-emerald-400 uppercase tracking-wider flex items-center gap-1">
        ...
        {/* Beraberlik */}
        <div className="p-3 sm:p-3.5 rounded-2xl bg-neutral-900/60 border border-amber-950/40 flex flex-col items-center justify-center text-center shadow-md">
          <span className="text-[10px] sm:text-[11px] font-extrabold text-amber-400 uppercase tracking-wider flex items-center gap-1">
        ...
        {/* Mağlubiyet */}
        <div className="p-3 sm:p-3.5 rounded-2xl bg-neutral-900/60 border border-red-950/40 flex flex-col items-center justify-center text-center shadow-md">
          <span className="text-[10px] sm:text-[11px] font-extrabold text-red-500 uppercase tracking-wider flex items-center gap-1">
        ...
        {/* Gol Averajı */}
        <div className="col-span-2 sm:col-span-4 md:col-span-1 p-3 sm:p-3.5 rounded-2xl bg-neutral-900/60 border border-neutral-800/80 flex flex-col items-center justify-center text-center shadow-md">
          <span className="text-[10px] sm:text-[11px] font-extrabold text-neutral-400 uppercase tracking-wider block">
            AVERAJ
          </span>

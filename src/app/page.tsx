...
export default function Home() {
  ...
  const loadData = async () => {
    ...
    try {
      const [fixturesRes, standingsRes] = await Promise.all([
        ...
        fetch('/bjk-standings.json').catch(() => null)
      ]);
  ...
  // Seçili Turnuvaya Göre Canlı Performans İstatistikleri Hesaplama (FotMob'dan %100 Doğru)
        ...
        <div className="space-y-3 pt-1">
          {loading ? (
            <div className="py-20 flex flex-col items-center justify-center text-center">
              ...
              <p className="text-xs sm:text-sm text-neutral-400 font-medium">Fikstür ve maçlar yükleniyor...</p>
            </div>
